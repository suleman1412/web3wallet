...
export default function CTA(){
    return(
        <FadeInDiv amount={0.5} duration={0.4} hidden={{ y:20, opacity: 0 }} visible={{ y:0, opacity: 1}}>
            <div className="mx-6 relative rounded-xl overflow-hidden min-h-[10em]">
                <div className="absolute inset-0 z-[-2] h-full">
                    <GradientCircle />
                </div>
                <div className="absolute top-1/2 left-1/2  min-w-[80%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center ">
                    <div className="flex flex-col items-center ">
                        <h1 className="font-sans md:text-3xl text-[1.2rem] text-center pt-2 font-bold text-background ">
                            Ready to Generate Your Keypairs?
                        </h1>
                        <h2 className="font-sans text-[0.6rem] text-accent text-center  pb-2 ">
